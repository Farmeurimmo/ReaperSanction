...
public class MuteGui {
    ...
    public static void mutegui(Player player, String cible) {
        if (player.hasPermission("mod")) {
            ...
            customS.setDisplayName(ConfigManager.instance.getFromConfigFormatted("Menu.Mutes.Bow.Reason"));
            ...
            customa.setDisplayName(ConfigManager.instance.getFromConfigFormatted("Menu.Mutes.DiamondSword.Reason"));
            ...
            customb.setDisplayName(ConfigManager.instance.getFromConfigFormatted("Menu.Mutes.Anvil.Reason"));
            ...
            customc.setDisplayName(ConfigManager.instance.getFromConfigFormatted("Menu.Mutes.RedstoneBlock.Reason"));
            ...
            customf.setDisplayName(ConfigManager.instance.getFromConfigFormatted("Menu.Mutes.ActivatorRail.Reason"));
            ...
            customg.setDisplayName(ConfigManager.instance.getFromConfigFormatted("Menu.Mutes.ArmorStand.Reason"));
            ...
            customh.setDisplayName(ConfigManager.instance.getFromConfigFormatted("Menu.Mutes.Compass.Reason"));
            ...
            customi.setDisplayName(ConfigManager.instance.getFromConfigFormatted("Menu.Mutes.FlintAndSteel.Reason"));
