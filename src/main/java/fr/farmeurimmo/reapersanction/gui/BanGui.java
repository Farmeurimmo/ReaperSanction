...
public class BanGui {
    ...
    public static void bangui(Player player, String cible) {
        if (player.hasPermission("mod")) {
            ...
            customS.setDisplayName("§6" + ReaperSanction.instance.getConfig().getString("ReaperSanction.Settings.Menu.Bans.DiamondSword.Reason"));
            custom1.setItemMeta(customS);
            inv.setItem(10, custom1);

            ItemStack custom2 = new ItemStack(Material.WOOD_SWORD, 1);
            ItemMeta customa = custom2.getItemMeta();
            customa.setDisplayName("§6" + ReaperSanction.instance.getConfig().getString("ReaperSanction.Settings.Menu.Bans.WoodSword.Reason"));
            ...
            customb.setDisplayName("§6" + ReaperSanction.instance.getConfig().getString("ReaperSanction.Settings.Menu.Bans.Feather.Reason"));
            ...
            customc.setDisplayName("§6" + ReaperSanction.instance.getConfig().getString("ReaperSanction.Settings.Menu.Bans.IronBoots.Reason"));
            ...
            customf.setDisplayName("§6" + ReaperSanction.instance.getConfig().getString("ReaperSanction.Settings.Menu.Bans.GoldAxe.Reason"));
            ...
            customg.setDisplayName("§6" + ReaperSanction.instance.getConfig().getString("ReaperSanction.Settings.Menu.Bans.ArmorStand.Reason"));
            ...
            customh.setDisplayName("§6" + ReaperSanction.instance.getConfig().getString("ReaperSanction.Settings.Menu.Bans.Tnt.Reason"));
            ...
            customi.setDisplayName("§6" + ReaperSanction.instance.getConfig().getString("ReaperSanction.Settings.Menu.Bans.Leather.Reason"));
            ...
            customj.setDisplayName("§6" + ReaperSanction.instance.getConfig().getString("ReaperSanction.Settings.Menu.Bans.DiamondChestPlate.Reason"));
            ...
            customk.setDisplayName("§6" + ReaperSanction.instance.getConfig().getString("ReaperSanction.Settings.Menu.Bans.Dirt.Reason"));
